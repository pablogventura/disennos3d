...
function circle_points(r = 1, a = 0) = 
    a < 360
       ? concat([[r * sin(a),  r * cos(a),0]], circle_points(r, a + 360 / lados)) 
       : [] ;
...
function circle_points(r = 1, a = 0) = 
    a < 360
       ? concat([[r * sin(a+17),  r * cos(a),0]], circle_points(r, a + 360 / lados)) 
       : [] ;
...
function loop_points(step, end, t = 0) = 
    t <= end 
       ...
       : [] ;
module superficie(){
//section_points = circle_points(Wire_radius, lados=20);
section_points = circle_points(Wire_radius, 360/lados);
//echo(section_points);
