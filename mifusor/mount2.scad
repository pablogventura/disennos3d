...
difference ()
{
  rotate ([0, -180, 0])
  {
	...
	rotate ([0, 180, 0]) translate ([-45 / 2 - 2 + 5, -15,
					 -5.6 - 3.7 - 6]) cube ([45, 40, 6]);
      }
  ...
  translate ([22, 16, -40]) rotate ([0, 90, 0]) scale ([1.05, 1.05,
							1.05]) 9 g_motor ();
  //translate([27.5,-2.5,-32-17])cylinder(r=10,h=35);
  translate ([10, -2.5 - 10, -32 - 17]) cube ([20, 18, 35]);
}

translate ([0, 25, -4 - 5.6 - 1 - 20]) mirror ([0, 0, 1]) rotate ([20, 0,
								   0])
translate ([-50 / 2, 0, 0]) scale ([50 / 40, 50 / 40, 1]) fan_mount (size =
								     40,
								     thick =
								     4);
...
difference ()
{
  translate ([0, 25, -4 - 5.6 - 1 - 20]) mirror ([0, 0, 1]) rotate ([20, 0,
								     0])
    translate ([-50 / 2, 0, 0]) scale ([50 / 40, 50 / 40, 1])
  {
    hull ()
    {
      translate ([0, 0, 4]) cube ([40, 40, 0.1]);
      translate ([20, 10, 20]) scale ([1, 0.5, 1]) rotate ([10, 0,
							    0]) cylinder (r =
									  15,
									  h =
									  0.1);
    ...
    hull ()
    {
      translate ([20, 10, 20]) scale ([1, 0.5, 1]) rotate ([10, 0,
							    0]) cylinder (r =
									  ...
									  h =
									  0.1);
      translate ([20, 0, 37]) scale ([0.7, 0.2, 1]) rotate ([5, 0,
							     0]) cylinder (r =
									   15,
									   h =
									   0.1);
    ...
    hull ()
    {
      translate ([20, 10, 20]) scale ([1, 0.5, 1]) rotate ([10, 0,
							    0]) cylinder (r =
									  ...
									  h =
									  0.1);
      translate ([20, 0, 38]) scale ([0.7, 0.1, 1]) rotate ([5, 0,
							     0]) cylinder (r =
									   13,
									   h =
									   0.1);
...
color ("Blue") translate ([-24.5 - 3, -15, -7.5 - 5.6 - 44 + 0.5])
cube ([3, 40, 7.5]);
color ("Blue") translate ([-24.5 - 3 + 2, -15, -7.5 - 5.6 - 44 + 0.5 + 1])
rotate ([0, 60, 0]) cube ([1, 40, 7.5]);
mirror ([1, 0, 0]) color ("Blue") translate ([-24.5 - 3 + 2, -15,
					      -7.5 - 5.6 - 44 + 0.5 +
					      1]) rotate ([0, 60,
							   0]) cube ([1, 40,
								      7.5]);

translate ([35, -4, -6.6 - 60 + 10]) difference ()
{
  cylinder (r = 10, h = 7);
  translate ([0, 0, -1]) cylinder (r = 8, h = 12);
}

translate ([35, -4, -11]) difference ()
{
  cylinder (r = 10, h = 7);
  translate ([0, 0, -1]) cylinder (r = 8, h = 12);
}
...
hull ()
{
  ...
  translate ([-20 / 2, 9, -57]) rotate ([0, 0, 45]) cube ([0.1, 20, 50]);
}
